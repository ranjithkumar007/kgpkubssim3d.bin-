...
# Example: ./start_penalty_kicker.sh 127.0.0.1
###########################################
...
SERVER_IP="--server=$1"
TEAM_NAME="--teamname=magmaOffenburg"
NUM="--playerid=8"
DECISIONMAKER="--decisionmaker=4"

java -cp $CLSPTH magma.robots.RoboCupClient $TEAM_NAME $NUM $SERVER_IP $DECISIONMAKER &
